...
apiurl = "https://shuriken.pm/api.php"
while True:
    ...
    if cmd == "0":
        ...
        if query != "~":
            ...
            def sitesPage():
                ...
                params = { "q": queryEncoded, "t": "0", "p": pageStr }
                ...
                if response.status_code == 200:
                    ...
                    try:
                        spinner.stop()
                        os.system('cls' if os.name == 'nt' else 'clear')
                        print(Fore.RED + "[ Search Sites ] " + Fore.BLACK + "Page " + pageStr + " | " + query)
                        ...
                        print(Fore.RED + " [X] Error decoding JSON response:", e)
